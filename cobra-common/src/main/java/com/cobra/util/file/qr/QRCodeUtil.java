package com.cobra.util.file.qr;
...
public class QRCodeUtil {
    public static void main(String[] args) throws Exception{
        // 存放在二维码中的内容
        String text = "测试生成二维码图片 一般用json";
        // 嵌入二维码的图片路径
        // 生成的二维码的路径及名称
        String destPath = "E:\\test\\jam.jpg";
        //生成二维码
    ...
    private static BufferedImage createImage(String content, boolean needCompress) throws Exception{
        ...
        // 嵌入logo
        QRCodeUtil.insertImage(image, needCompress);
        return image;
    }
    ...
    private static void insertImage(BufferedImage source, boolean needCompress) throws Exception{
        String imgPath;
        try {
            imgPath = QRCodeUtil.class.getClassLoader().getResource("logo.jpg").getPath();
