...
public class MapUtils
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("原序:" + initList);
        initList.sort(((o1, o2) -> o1.compareTo(o2)));
        System.out.println("升序:" + initList);

        initList.sort(((o2, o1) -> o1.compareTo(o2)));
        System.out.println("降序:" + initList);
